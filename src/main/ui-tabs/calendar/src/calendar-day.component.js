        ...
        execute: function() {
            ...
            calendarDayComponent = (function () {
                function calendarDayComponent(_daysService, _lifetargetService) {
                    ...
                    this.mainTargetIsSet = false;
                    this.backToMonth = new core_1.EventEmitter();
                    this.newDoing = { month: 0, description: '', important: false, target: '', urgent: false, main: false, global: 0, time: 0 };
                }
                calendarDayComponent.prototype.ngOnInit = function () {
                    ...
                    for (var i in this.data.doings) {
                        if (this.data.doings[i].main == true)
                            this.mainTargetIsSet = true;
                    }
                };
                ...
                calendarDayComponent.prototype.onChangeMainDoing = function (doing) {
                    if (doing.main) {
                        doing.main = false;
                        this.mainTargetIsSet = false;
                    }
