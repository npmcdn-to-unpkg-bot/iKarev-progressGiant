...
export class CalendarComponent{
    ...
    onAddMonth(){
        ...
        for(var i = 0; i < daysQty; i++) days[i] = {index:i, date:{year:2016,month:newMonth,number:i+1,weekday:(i+1)%7},doings:[], deadlines:[], done:false, routine:[{doing:'',time:0}]};
