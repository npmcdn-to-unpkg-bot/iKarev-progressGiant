...
export const LIFETARGET: ILifeTarget = {target:'',globalTargets:[{target:'',time:0,role:'',longTargets:[{target:'',shortTargets:[{target:'',deadline: {year:0,month:0,weekday:0,number:0}, doings: [],why: '',done:false}]}]}]};
